            ...
            <Table sx={{ tableLayout: 'fixed' }} stickyHeader aria-label="sticky table">
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell sx={{ width: 160 }}>{t('phone')}</StyledTableCell>
                        <StyledTableCell sx={{ width: 160 }}>{t('fax')}</StyledTableCell>
                        <StyledTableCell sx={{ width: 200 }}>{t('email')}</StyledTableCell>
                        <StyledTableCell sx={{ width: 200 }}>{t('note')}</StyledTableCell>
                ...
                <TableBody>
                    ...
                    {(rowsPerPage > 0 && rowsData
                        ...
                        view === 'edit' && editItem?.supplier_id === row?.supplier_id ? (
                            <EditPanel
                                row={row}
                                onBack={handleBackClick}
                                onSave={handleSaveClick}
                            />
                        ) : view === 'delete' && editItem?.supplier_id === row?.supplier_id ? (
                            <DeletePanel
                                row={row}
                                onBack={handleBackClick}

...
export async function getServerSideProps(ctx) {
  ...
  let datas = [];
  try {
    const res = await axios.get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/payment-method`, {
      headers: {
...
export default function Page({ datas }: { datas: PaymentMethod[] }) {

    const { t } = useTranslation('common')

    const [data, setData] = useState<PaymentMethod[]>(datas);

...
export default function Page({ rows }: TableProps) {
    ...
    const [editItem, setEditItem] = React.useState<TaxRate | null>(null);
            ...
            <Table sx={{ tableLayout: 'fixed' }} aria-label="custom pagination table">
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell sx={{ width: 200 }}>{t('value')}</StyledTableCell>
                ...
                <TableBody>
                    ...
                    {(rowsPerPage > 0 && rowsData
                        ...
                        view === 'edit' && editItem?.tax_rate_id === row?.tax_rate_id ? (
                            <EditPanel
                                row={row}
                                onBack={handleBackClick}
                                onSave={handleSaveClick}
                            />
                        ) : view === 'delete' && editItem?.tax_rate_id === row?.tax_rate_id ? (
                            <DeletePanel
                                row={row}
                                onBack={handleBackClick}
